                            ...
                            <div class="card-body">
                                <form action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 lang-section lang-uz">
                                        ...
                                        <input type="text" name="title_uz" class="form-control" id="title_uz" value="{{ $brand->title_uz }}" placeholder="Sarlavhani kiriting" required>
                                    </div>

                                    <!-- Title RU -->
                                    <div class="mb-3 lang-section lang-ru d-none">
                                        <label for="title_ru" class="form-label">Sarlavha (RU)</label>
                                        <input type="text" name="title_ru" class="form-control" id="title_ru" value="{{ $brand->title_ru }}" placeholder="Введите заголовок" required>
                                    </div>

                                    <!-- Title EN -->
                                    <div class="mb-3 lang-section lang-en d-none">
                                        <label for="title_en" class="form-label">Title (EN)</label>
                                        <input type="text" name="title_en" class="form-control" id="title_en" value="{{ $brand->title_en }}" placeholder="Enter title" required>
                                    </div>

                                    <!-- Description UZ -->
                                    <div class="mb-3 lang-section lang-uz">
                                        <label for="description_uz" class="form-label">Tavsif (UZ)</label>
                                        <textarea name="description_uz" class="form-control" id="description_uz" rows="4" placeholder="Tavsifni kiriting">{{ $brand->description_uz }}</textarea>
                                    </div>

                                    <!-- Description RU -->
                                    <div class="mb-3 lang-section lang-ru d-none">
                                        <label for="description_ru" class="form-label">Tavsif (RU)</label>
                                        <textarea name="description_ru" class="form-control" id="description_ru" rows="4" placeholder="Введите описание">{{ $brand->description_ru }}</textarea>
                                    </div>

                                    <!-- Description EN -->
                                    <div class="mb-3 lang-section lang-en d-none">
                                        <label for="description_en" class="form-label">Description (EN)</label>
                                        <textarea name="description_en" class="form-control" id="description_en" rows="4" placeholder="Enter description">{{ $brand->description_en }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="form-text text-muted">Hozirgi rasm: <img src="{{ asset('storage/' . $brand->image) }}" alt="Brand Image" width="100"></small>
                                    </div>

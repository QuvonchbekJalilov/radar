            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-4 align-items-center lang-section lang-uz">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="title_uz" name="title_uz" value="{{ $brand->title_uz }}" placeholder="Enter title in Uzbek" required>
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-type"></i></div>
                                                <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{ $brand->title_ru }}" placeholder="Enter title in Russian" required>
                                            </div>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-type"></i></div>
                                                <input type="text" class="form-control" id="title_en" name="title_en" value="{{ $brand->title_en }}" placeholder="Enter title in English" required>
                                            </div>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-uz">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="description_uz" name="description_uz" placeholder="Enter description in Uzbek" rows="4">{{ $brand->description_uz }}</textarea>
                                            </div>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-align-left"></i></div>
                                                <textarea class="form-control" id="description_ru" name="description_ru" placeholder="Enter description in Russian" rows="4">{{ $brand->description_ru }}</textarea>
                                            </div>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-align-left"></i></div>
                                                <textarea class="form-control" id="description_en" name="description_en" placeholder="Enter description in English" rows="4">{{ $brand->description_en }}</textarea>
                                            </div>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>

                            ...
                            <div class="card-body">
                                <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 lang-section lang-uz">
                                        ...
                                        <input type="text" name="name_uz" class="form-control" id="name_uz" placeholder="Nomi o'zbek tilida kiriting" value="{{ $category->name_uz }}" required>
                                    </div>

                                    <!-- Name RU -->
                                    <div class="mb-3 lang-section lang-ru d-none">
                                        <label for="name_ru" class="form-label">Nomi (RU)</label>
                                        <input type="text" name="name_ru" class="form-control" id="name_ru" placeholder="Nomini rus tilida kiriting" value="{{ $category->name_ru }}" required>
                                    </div>

                                    <!-- Name EN -->
                                    <div class="mb-3 lang-section lang-en d-none">
                                        <label for="name_en" class="form-label">Name (EN)</label>
                                        <input type="text" name="name_en" class="form-control" id="name_en" placeholder="Enter name" value="{{ $category->name_en }}" required>
                                    </div>

                                ...
                                <form action="{{ route('category.store')}}" method="POST" class="needs-validation dropzone" enctype="multipart/form-data" novalidate id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-uz">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="Nomi o'zbek tilida kiriting" name="name_uz" required>
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-type"></i></div>
                                                <input class="form-control" placeholder="Nomini rus tilida kiriting" name="name_ru" required>
                                            </div>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-type"></i></div>
                                                <input class="form-control" placeholder="Nomini ingliz tilida kiriting" name="name_en" required>
                                            </div>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
